...
export const metadata: Metadata = { title: "Terms of Service — LootNestX" }

export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:py-20">
      <h1 className="text-3xl font-bold tracking-tight mb-8">Terms of Service — LootNestX</h1>
      <div className="prose prose-invert prose-zinc max-w-none space-y-4 text-muted leading-relaxed">
        ...
        <p>By using LootNestX, you agree to these terms. If you disagree, please discontinue use.</p>
        <h2 className="text-xl font-semibold text-foreground mt-8">2. Service Description</h2>
        <p>LootNestX provides free browser-based tools. All tools run locally in your browser — we do not host or process your data on our servers.</p>
