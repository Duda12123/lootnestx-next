...
export const metadata: Metadata = { title: "Terms of Service — ToolNest" }
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:py-20">
      ...
      <div className="prose prose-invert prose-zinc max-w-none space-y-4 text-muted leading-relaxed">
        ...
        <p>By using ToolNest, you agree to these terms. If you disagree, please discontinue use.</p>
        <h2 className="text-xl font-semibold text-foreground mt-8">2. Service Description</h2>
        <p>ToolNest provides free browser-based tools. All tools run locally in your browser — we do not host or process your data on our servers.</p>
        ...
        <p>ToolNest shall not be liable for any damages arising from the use or inability to use our tools.</p>
