...
"sql-formatter": dynamic(() => import("@/tools/SqlFormatter")),
  ...
  "nato-alphabet": dynamic(() => import("@/tools/NatoAlphabet")),
  "mortgage-calc": dynamic(() => import("@/tools/MortgageCalculator")),
  "gpa-calc": dynamic(() => import("@/tools/GpaCalculator")),
  "gas-calc": dynamic(() => import("@/tools/GasCalculator")),
  "sales-tax": dynamic(() => import("@/tools/SalesTaxCalculator")),
  "sleep-calc": dynamic(() => import("@/tools/SleepCalculator")),
  "cooking-converter": dynamic(() => import("@/tools/CookingConverter")),
  "sqft-calc": dynamic(() => import("@/tools/SquareFootageCalculator")),
  "youtube-thumbnail": dynamic(() => import("@/tools/YoutubeThumbnail")),
  "name-generator": dynamic(() => import("@/tools/NameGenerator")),
  "gaming-name-generator": dynamic(() => import("@/tools/GamingNameGenerator")),
  "meme-generator": dynamic(() => import("@/tools/MemeGenerator")),
  "logo-generator": dynamic(() => import("@/tools/LogoGenerator")),
  ...
  "summer-gadget-showdown-2026": dynamic(() => import("@/tools/SummerGadgetShowdown2026")),
  "summer-gadget-deal-calculator": dynamic(() => import("@/tools/SummerGadgetDealCalculator")),
  "summer-cooling-gadget-finder": dynamic(() => import("@/tools/SummerCoolingGadgetFinder")),
}
